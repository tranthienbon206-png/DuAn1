...
<div class="container py-5">
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-4">
            <div class="card shadow-sm h-100">
                <div class="card-header bg-primary text-white">Thông Tin Liên Hệ</div>
                <div class="card-body">
        ...
        <div class="col-lg-8">
            <div class="card shadow-sm">
                <div class="card-header bg-success text-white">Gửi Tin Nhắn</div>
                <div class="card-body">
                    ...
                    <form action="index.php?action=contact" method="post">
                        ...
                        <?php if ($isLoggedIn): ?>
                            ...
                            <div class="alert alert-light border d-flex align-items-center mb-3">
                                <i class="bi bi-person-check fs-5 me-2 text-success"></i>
                                Đang gửi với tư cách: <strong class="ms-1"><?= htmlspecialchars($_SESSION['user']['name']) ?></strong>
    ...
    <div class="card shadow-sm mt-5">
        <div class="card-header bg-dark text-white">Bản Đồ</div>
