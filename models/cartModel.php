...
class CartModel {
    ...
    // Tính tổng tiền giỏ hàng (dùng price lưu sẵn trong bảng cart, không lấy giá mới từ products)
    ...
    // Đếm tổng số sản phẩm trong giỏ (hiển thị badge ở menu)
    ...
    // Thêm sản phẩm vào giỏ (nếu đã có thì cộng dồn số lượng, giữ nguyên price cũ)
    public function addToCart($user_id, $product_id, $qty = 1) {
        ...
        // Chưa có -> lấy giá hiện tại của sản phẩm để lưu snapshot vào cart
    ...
    // Xóa sạch giỏ hàng (dùng sau khi checkout xong)
